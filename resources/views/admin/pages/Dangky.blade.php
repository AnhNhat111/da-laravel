                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                    ...
                                    <a class="text-center"> <h4>Đăng ký</h4></a>
                                ...
                                <form class="mt-5 mb-5 login-input">
                                    ...
                                    <p class="mt-5 login-form__footer">Nếu đã có tài khoản. Mình <a href="{{ route('Dangnhap')}}" class="text-primary">Đăng nhập </a> ngay nhé.</p>
                                    </p>
                                </div>
                            </div>
                        </div>
