                        ...
                        <div class="form-input-content">
                            <div class="card login-form mb-0">
                                <div class="card-body pt-5">
                                    ...
                                    <form class="mt-5 mb-5 login-input" action="{{ route('user.signup.post') }}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <input type="text" class="form-control" type="text" id ="SODIENTHOAI" name="SODIENTHOAI"  placeholder="Phone" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" type="text" id ="TENHIENTHI" name="TENHIENTHI"  placeholder="Name" required>
                                        </div>
                                        <div class="form-group">
